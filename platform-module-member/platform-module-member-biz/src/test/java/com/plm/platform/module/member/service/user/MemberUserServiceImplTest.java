package com.plm.platform.module.member.service.user;
...
import com.plm.platform.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import com.plm.platform.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, PlatformRedisAutoConfiguration.class})

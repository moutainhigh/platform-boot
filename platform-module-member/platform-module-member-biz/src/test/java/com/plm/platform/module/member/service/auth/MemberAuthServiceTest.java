...
import com.plm.platform.module.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import com.plm.platform.module.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
...
// TODO @测试：单测的 review，等逻辑都达成一致后
/**
 * {@link MemberAuthService} 的单元测试类
 *
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, PlatformRedisAutoConfiguration.class})

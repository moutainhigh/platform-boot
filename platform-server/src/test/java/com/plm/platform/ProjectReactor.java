...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.plm.boot";
    private static final String ARTIFACT_ID = "platform";
    private static final String PACKAGE_NAME = "com.plm.platform";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.plm.boot";
        String artifactIdNew = "platform";
        String packageNameNew = "com.plm.platform";
        String titleNew = "后台管理系统";
        //String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "D:\\IDEAWorkspace\\plm\\platform-boot";

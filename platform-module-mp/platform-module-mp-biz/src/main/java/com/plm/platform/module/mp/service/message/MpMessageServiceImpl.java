package com.plm.platform.module.mp.service.message;
...
import com.plm.platform.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import com.plm.platform.module.mp.convert.message.MpMessageConvert;
...
import com.plm.platform.module.mp.dal.dataobject.user.MpUserDO;
import com.plm.platform.module.mp.dal.mysql.message.MpMessageMapper;
import com.plm.platform.module.mp.enums.message.MpMessageSendFromEnum;
...
import com.plm.platform.module.mp.service.material.MpMaterialService;
import com.plm.platform.module.mp.service.message.bo.MpMessageSendOutReqBO;
import com.plm.platform.module.mp.service.user.MpUserService;
...
import static com.plm.platform.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;

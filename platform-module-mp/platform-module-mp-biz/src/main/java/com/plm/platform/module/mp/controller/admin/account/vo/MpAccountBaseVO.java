package com.plm.platform.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", required = true, example = "PDM")
    @NotEmpty(message = "公众号名称不能为空")
    private String name;

    @Schema(description = "公众号微信号", required = true, example = "platformyuanma")
    ...
    @Schema(description = "备注", example = "请关注PDM，学习技术")

package com.plm.platform.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.plm.platform.framework.social.core.enums.AuthExtendSource;
import com.plm.platform.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class PlatformAuthRequestFactory extends AuthRequestFactory {
    ...
    public PlatformAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {

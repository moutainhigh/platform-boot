package com.plm.platform.framework.test.core.ut;
...
import com.plm.platform.framework.test.config.RedisTestConfiguration;
import com.plm.platform.framework.test.config.SqlInitializationTestConfiguration;

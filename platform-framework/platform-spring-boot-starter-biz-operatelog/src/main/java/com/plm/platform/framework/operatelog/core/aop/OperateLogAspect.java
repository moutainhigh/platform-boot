package com.plm.platform.framework.operatelog.core.aop;
...
import com.plm.platform.framework.operatelog.core.service.OperateLog;
import com.plm.platform.framework.operatelog.core.service.OperateLogFrameworkService;
import com.plm.platform.framework.web.core.util.WebFrameworkUtils;
...
import static com.plm.platform.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.plm.platform.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.plm.platform.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.plm.platform.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.plm.platform.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.plm.platform.framework.operatelog.core.annotations.OperateLog operateLog,

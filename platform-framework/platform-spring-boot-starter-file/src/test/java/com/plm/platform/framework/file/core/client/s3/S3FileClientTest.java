...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("platformyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("platform-foundation");
        config.setDomain("http://test.platform.example.com"); // 如果有自定义域名，则可以设置。http://static.platform.example.com
        // 默认上海的 endpoint

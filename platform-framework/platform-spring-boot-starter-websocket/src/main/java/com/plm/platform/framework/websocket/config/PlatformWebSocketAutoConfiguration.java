 ...
 */
@AutoConfiguration
// 允许使用 platform.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "platform.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class PlatformWebSocketAutoConfiguration {
    @Bean

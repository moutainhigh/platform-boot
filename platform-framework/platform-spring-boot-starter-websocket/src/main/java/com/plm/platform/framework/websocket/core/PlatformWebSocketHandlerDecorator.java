package com.plm.platform.framework.websocket.core;
...
public class PlatformWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public PlatformWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }

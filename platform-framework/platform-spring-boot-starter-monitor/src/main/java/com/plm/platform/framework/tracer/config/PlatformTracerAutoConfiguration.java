...
import com.plm.platform.framework.tracer.core.aop.BizTraceAspect;
import com.plm.platform.framework.tracer.core.filter.TraceFilter;
...
public class PlatformTracerAutoConfiguration {

    // TODO @测试：重要。目前 opentracing 版本存在冲突，要么保证 skywalking，要么保证阿里云短信 sdk
//    @Bean

...
import com.plm.platform.module.pay.controller.admin.merchant.vo.merchant.*;
import com.plm.platform.module.pay.convert.merchant.PayMerchantConvert;
...
public class PayMerchantController {
    ...
    @Parameter(name = "name", description = "商户名称", example = "PDM")
    @PreAuthorize("@ss.hasPermission('pay:merchant:query')")

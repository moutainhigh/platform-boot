...
import com.plm.platform.framework.common.exception.util.ServiceExceptionUtil;
...
import com.plm.platform.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import com.plm.platform.framework.pay.core.enums.PayNotifyRefundStatusEnum;
...
import com.plm.platform.module.pay.dal.mysql.refund.PayRefundMapper;
...
import com.plm.platform.module.pay.enums.refund.PayRefundStatusEnum;
import com.plm.platform.module.pay.enums.refund.PayRefundTypeEnum;
...
import com.plm.platform.module.pay.service.order.PayOrderExtensionService;
...
public class PayRefundServiceImpl implements PayRefundService {
    ...
    public Long createPayRefund(PayRefundCreateReqDTO reqDTO) {
        ...
        if(Objects.nonNull(payRefundDO)){
            ...
            payRefundDO = PayRefundDO.builder()
                    ...
                    .orderId(order.getId())
                    .merchantRefundNo(merchantRefundId) // TODO 测试：需要优化
        ...
        unifiedReqDTO.setUserIp(reqDTO.getUserIp())
                ...
                .setMerchantRefundId(merchantRefundId)  // TODO 测试：需要优化
                .setNotifyUrl(genChannelPayNotifyUrl(channel)) // TODO 测试：优化下 notifyUrl
    ...
    public void notifyPayRefund(Long channelId, PayRefundNotifyRespDTO notify, PayNotifyReqDTO rawNotify) {
        ...
        if (Objects.equals(PayNotifyRefundStatusEnum.SUCCESS, notify.getStatus())){
            ...
            // TODO @jason：那这里可以考虑打个 error logger @测试 微信是否存在支付异常通知
        }
    }

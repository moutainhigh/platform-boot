...
import com.plm.platform.framework.pay.config.PayProperties;
import com.plm.platform.framework.pay.core.client.PayClient;
...
import com.plm.platform.framework.pay.core.client.dto.notify.PayOrderNotifyRespDTO;
...
import com.plm.platform.framework.tenant.core.util.TenantUtils;
import com.plm.platform.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.plm.platform.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import com.plm.platform.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import com.plm.platform.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import com.plm.platform.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
...
import com.plm.platform.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.plm.platform.module.pay.dal.mysql.order.PayOrderMapper;
import com.plm.platform.module.pay.enums.ErrorCodeConstants;
import com.plm.platform.module.pay.enums.notify.PayNotifyTypeEnum;
import com.plm.platform.module.pay.enums.order.PayOrderNotifyStatusEnum;
import com.plm.platform.module.pay.enums.order.PayOrderStatusEnum;
import com.plm.platform.module.pay.service.merchant.PayAppService;
import com.plm.platform.module.pay.service.merchant.PayChannelService;
...
import static com.plm.platform.framework.common.util.json.JsonUtils.*;
...
public class PayOrderServiceImpl implements PayOrderService {
    ...
    public Long createPayOrder(PayOrderCreateReqDTO reqDTO) {
        ...
        // 退款相关字段
        // todo @测试 创建支付的订单的退款状态枚举是不是有问题，应该是 PayRefundTypeEnum 吧 您这填写的是 PayOrderNotifyStatusEnum 回调状态枚举
...
//    a690389285100
        // 目前的算法
        // 时间序列，年月日时分秒 14 位
        // 纯随机，6 位 TODO 测试：此处估计是会有问题的，后续在调整

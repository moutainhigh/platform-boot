package com.plm.platform.module.product.controller.app.spu.vo;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", required = true, example = "PDM")
    private String name;
    ...
    public static class Sku {
        ...
        @Schema(description = "图片地址", required = true, example = "https://www.example.com/xx.png")

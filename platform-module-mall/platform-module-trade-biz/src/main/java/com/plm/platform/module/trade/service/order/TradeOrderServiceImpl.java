package com.plm.platform.module.trade.service.order;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.IdUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.plm.platform.framework.common.core.KeyValue;
import com.plm.platform.framework.common.enums.CommonStatusEnum;
import com.plm.platform.framework.common.enums.TerminalEnum;
...
import com.plm.platform.framework.common.util.json.JsonUtils;
import com.plm.platform.module.member.api.address.AddressApi;
...
import com.plm.platform.module.pay.api.order.PayOrderApi;
...
import com.plm.platform.module.pay.enums.order.PayOrderStatusEnum;
import com.plm.platform.module.product.api.sku.ProductSkuApi;
import com.plm.platform.module.product.api.sku.dto.ProductSkuRespDTO;
import com.plm.platform.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.plm.platform.module.product.api.spu.ProductSpuApi;
import com.plm.platform.module.product.api.spu.dto.ProductSpuRespDTO;
import com.plm.platform.module.product.enums.spu.ProductSpuStatusEnum;
import com.plm.platform.module.promotion.api.coupon.CouponApi;
import com.plm.platform.module.promotion.api.coupon.dto.CouponUseReqDTO;
import com.plm.platform.module.promotion.api.price.PriceApi;
...
import com.plm.platform.module.trade.controller.app.order.vo.AppTradeOrderCreateReqVO;
import com.plm.platform.module.trade.controller.app.order.vo.AppTradeOrderCreateReqVO.Item;
import com.plm.platform.module.trade.controller.app.order.vo.AppTradeOrderPageReqVO;
...
import com.plm.platform.module.trade.dal.mysql.order.TradeOrderItemMapper;
import com.plm.platform.module.trade.dal.mysql.order.TradeOrderMapper;
import com.plm.platform.module.trade.enums.ErrorCodeConstants;
import com.plm.platform.module.trade.enums.order.*;
import com.plm.platform.module.trade.framework.order.config.TradeOrderProperties;
...
import static com.plm.platform.framework.common.util.collection.CollectionUtils.*;
import static com.plm.platform.module.pay.enums.ErrorCodeConstants.PAY_ORDER_NOT_FOUND;
import static com.plm.platform.module.trade.enums.ErrorCodeConstants.*;
...
public class TradeOrderServiceImpl implements TradeOrderService {
    ...
    public void receiveOrder(Long userId, Long id) {
        ...
        // TODO 测试：lili 发送订单变化的消息

        // TODO 测试：lili 发送商品被购买完成的数据
    }
    ...
    public void updateOrderItemAfterSaleStatus(Long id, Integer oldAfterSaleStatus, Integer newAfterSaleStatus, Integer refundPrice) {
        ...
        // TODO 测试：未来如果有分佣，需要更新相关分佣订单为已失效
    }

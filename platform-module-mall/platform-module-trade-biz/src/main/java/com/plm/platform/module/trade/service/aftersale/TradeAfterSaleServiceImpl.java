...
import com.plm.platform.module.trade.controller.app.aftersale.vo.AppTradeAfterSaleDeliveryReqVO;
...
public class TradeAfterSaleServiceImpl implements TradeAfterSaleService {
    ...
    private TradeAfterSaleDO createAfterSale(AppTradeAfterSaleCreateReqVO createReqVO,
        ...
        afterSale.setNo(RandomUtil.randomString(10)); // TODO 测试：优化 no 生成逻辑

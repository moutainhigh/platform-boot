...
import com.plm.platform.module.trade.framework.order.config.TradeOrderConfig;
...
public class TradeOrderServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateTradeOrder_success() {
        ...
        // mock 方法（用户收件地址的校验）
        AddressRespDTO addressRespDTO = new AddressRespDTO().setId(10L).setUserId(userId).setName("测试")
        ...
        assertEquals(tradeOrderDO.getReceiverName(), "测试");

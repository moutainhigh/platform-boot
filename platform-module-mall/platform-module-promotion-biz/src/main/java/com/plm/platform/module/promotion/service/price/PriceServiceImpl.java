...
import com.plm.platform.module.promotion.convert.price.PriceConvert;
...
import com.plm.platform.module.promotion.enums.common.*;
import com.plm.platform.module.promotion.enums.coupon.CouponStatusEnum;
import com.plm.platform.module.promotion.service.coupon.CouponService;
import com.plm.platform.module.promotion.service.discount.DiscountActivityService;
import com.plm.platform.module.promotion.service.discount.bo.DiscountProductDetailBO;
import com.plm.platform.module.promotion.service.reward.RewardActivityService;
...
import static com.plm.platform.framework.common.util.collection.CollectionUtils.getSumValue;
import static com.plm.platform.module.product.enums.ErrorCodeConstants.SKU_NOT_EXISTS;
import static com.plm.platform.module.promotion.enums.ErrorCodeConstants.*;
...
//                            .setMeetTip(String.format("差 %s 元可用优惠劵", formatPrice(coupon.getUsePrice() - originPrice)));
     ...
     * 计算商品级别的价格，例如说：
     * 1. 会员折扣
     * 2. 限时折扣 {@link com.plm.platform.module.promotion.dal.dataobject.discount.DiscountActivityDO}
     *
     * 其中，会员折扣、限时折扣取最低价
     *
     * @param userId 用户编号
    ...
    /**
     * 计算订单级别的价格，例如说：
     * 1. 满减送 {@link com.plm.platform.module.promotion.dal.dataobject.reward.RewardActivityDO}
     *
     * @param userId 用户编号
     * @param priceCalculate 价格计算的结果
     */
    ...
    private void addPromotion(PriceCalculateRespDTO priceCalculate, PriceCalculateRespDTO.OrderItem orderItem,
        ...
        // 创建营销明细 Item
        // TODO 测试：orderItem.getPayPrice() 要不要改成 orderDividePrice；同时，newPayPrice 要不要改成直接传递 discountPrice

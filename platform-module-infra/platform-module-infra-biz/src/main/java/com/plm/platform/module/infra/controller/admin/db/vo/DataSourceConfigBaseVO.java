package com.plm.platform.module.infra.controller.admin.db.vo;
...
public class DataSourceConfigBaseVO {
    ...
    @Schema(description = "数据源连接", required = true, example = "jdbc:mysql://127.0.0.1:3306/platform-foundation")

package com.plm.platform.module.infra.service.codegen.inner;
...
import com.plm.platform.framework.common.util.date.LocalDateTimeUtils;
import com.plm.platform.framework.common.util.object.ObjectUtils;
import com.plm.platform.framework.excel.core.annotations.DictFormat;
import com.plm.platform.framework.excel.core.convert.DictConvert;
import com.plm.platform.framework.excel.core.util.ExcelUtils;
...
import com.plm.platform.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "platform-module-${table.moduleName}/" + // 顶级模块
                "platform-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "platform-module-${table.moduleName}/" + // 顶级模块
                "platform-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "platform-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "platform-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}

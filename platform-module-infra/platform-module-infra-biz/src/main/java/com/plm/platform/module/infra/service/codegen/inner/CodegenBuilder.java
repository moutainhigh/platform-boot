...
import com.plm.platform.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import com.plm.platform.module.infra.enums.codegen.CodegenColumnListConditionEnum;
import com.plm.platform.module.infra.enums.codegen.CodegenTemplateTypeEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link com.plm.platform.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getJavaField(), "name")) {
            column.setExample(randomEle(new String[]{"张三", "李四", "王五", "赵六", "测试"}));
            return;
        }
        // status

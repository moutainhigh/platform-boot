...
import com.plm.platform.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import com.plm.platform.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.plm.platform.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.plm.platform.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.plm.platform.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.plm.platform.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.plm.platform.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("platform-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("platform-test");

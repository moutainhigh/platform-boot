package com.plm.platform.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.plm.platform.framework.common.pojo.PageResult;
import com.plm.platform.framework.file.core.client.FileClient;
import com.plm.platform.framework.file.core.client.FileClientConfig;
import com.plm.platform.framework.file.core.client.FileClientFactory;
import com.plm.platform.framework.file.core.client.local.LocalFileClient;
import com.plm.platform.framework.file.core.client.local.LocalFileClientConfig;
import com.plm.platform.framework.file.core.enums.FileStorageEnum;
import com.plm.platform.framework.test.core.ut.BaseDbUnitTest;
import com.plm.platform.module.infra.controller.admin.file.vo.config.FileConfigCreateReqVO;
import com.plm.platform.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.plm.platform.module.infra.controller.admin.file.vo.config.FileConfigUpdateReqVO;
import com.plm.platform.module.infra.dal.dataobject.file.FileConfigDO;
import com.plm.platform.module.infra.dal.mysql.file.FileConfigMapper;
import com.plm.platform.module.infra.mq.producer.file.FileConfigProducer;
import lombok.Data;
...
import static com.plm.platform.framework.test.core.util.RandomUtils.randomLongId;
import static com.plm.platform.framework.test.core.util.RandomUtils.randomPojo;
import static com.plm.platform.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.plm.platform.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
       // mock 数据
       FileConfigDO dbFileConfig = randomFileConfigDO().setName("PDM")

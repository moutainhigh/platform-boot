<template>
  <div class="app-container order-detail-page">
    ...
    <el-descriptions title="订单信息">
      ...
      <el-descriptions-item label="配送方式">物流配送</el-descriptions-item> <!-- TODO 测试：待实现 -->
      <el-descriptions-item label="营销活动">物流配送</el-descriptions-item> <!-- TODO 测试：待实现 -->
      ...
      <el-descriptions-item label="买家">{{ order.user.nickname }}</el-descriptions-item> <!-- TODO 测试：待实现：跳转会员 -->
    ...
    <el-descriptions title="订单状态" :column="1">
      ...
      <el-descriptions-item label-class-name="no-colon">
        <el-button type="primary" size="small">调整价格</el-button>  <!-- TODO 测试：待实现 -->
        <el-button type="primary" size="small">备注</el-button> <!-- TODO 测试：待实现 -->
        <el-button type="primary" size="small">发货</el-button> <!-- TODO 测试：待实现 -->
        <el-button type="primary" size="small">关闭订单</el-button>  <!-- TODO 测试：待实现 -->
        <el-button type="primary" size="small">修改地址</el-button>  <!-- TODO 测试：待实现 -->
        <el-button type="primary" size="small">打印电子面单</el-button>  <!-- TODO 测试：待实现 -->
        <el-button type="primary" size="small">打印发货单</el-button>  <!-- TODO 测试：待实现 -->
        <el-button type="primary" size="small">确认收货</el-button>  <!-- TODO 测试：待实现 -->
      </el-descriptions-item>

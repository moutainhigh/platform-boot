package com.plm.platform.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelBaseVO {
    ...
    @Schema(description = "短信签名", required = true, example = "PDM")
    ...
    @Schema(description = "短信 API 的账号", required = true, example = "platform")

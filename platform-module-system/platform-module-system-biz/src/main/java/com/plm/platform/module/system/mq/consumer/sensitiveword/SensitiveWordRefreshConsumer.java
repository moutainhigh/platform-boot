package com.plm.platform.module.system.mq.consumer.sensitiveword;

import com.plm.platform.framework.mq.core.pubsub.AbstractChannelMessageListener;
import com.plm.platform.module.system.mq.message.sensitiveword.SensitiveWordRefreshMessage;

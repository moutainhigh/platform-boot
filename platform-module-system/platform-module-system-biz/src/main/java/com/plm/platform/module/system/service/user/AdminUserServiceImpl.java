...
import com.plm.platform.framework.datapermission.core.util.DataPermissionUtils;
...
import com.plm.platform.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:platformyuanma}")

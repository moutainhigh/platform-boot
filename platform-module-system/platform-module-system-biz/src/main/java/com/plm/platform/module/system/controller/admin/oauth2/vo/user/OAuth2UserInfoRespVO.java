package com.plm.platform.module.system.controller.admin.oauth2.vo.user;
...
public class OAuth2UserInfoRespVO {
    ...
    @Schema(description = "用户账号", required = true, example = "测试")
    private String username;

    @Schema(description = "用户昵称", required = true, example = "PDM")

package com.plm.platform.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientBaseVO {
    ...
    @Schema(description = "应用图标", required = true, example = "https://www.example.com/xx.png")
    ...
    @Schema(description = "可重定向的 URI 地址", required = true, example = "https://www.example.com")

package com.plm.platform.module.system.controller.admin.dept.vo.dept;
...
public class DeptBaseVO {
    ...
    @Schema(description = "菜单名称", required = true, example = "PDM")
    ...
    @Schema(description = "邮箱", example = "platform@example.com")

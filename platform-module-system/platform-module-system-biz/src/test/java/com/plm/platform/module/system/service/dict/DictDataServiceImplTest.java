...
import com.plm.platform.module.system.controller.admin.dict.vo.data.DictDataCreateReqVO;
import com.plm.platform.module.system.controller.admin.dict.vo.data.DictDataExportReqVO;
import com.plm.platform.module.system.controller.admin.dict.vo.data.DictDataPageReqVO;
import com.plm.platform.module.system.controller.admin.dict.vo.data.DictDataUpdateReqVO;
import com.plm.platform.module.system.dal.dataobject.dict.DictDataDO;
import com.plm.platform.module.system.dal.dataobject.dict.DictTypeDO;
import com.plm.platform.module.system.dal.mysql.dict.DictDataMapper;
...
public class DictDataServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetDictDataPage() {
        ...
        // 测试 label 不匹配
        dictDataMapper.insert(cloneIgnoreId(dbDictData, o -> o.setLabel("测试")));
        // 测试 dictType 不匹配

package com.plm.platform.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.plm.platform.framework.common.enums.CommonStatusEnum;
import com.plm.platform.framework.common.exception.ServiceException;
import com.plm.platform.framework.common.pojo.PageResult;
import com.plm.platform.framework.common.util.collection.ArrayUtils;
...
import com.plm.platform.module.infra.api.file.FileApi;
import com.plm.platform.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.plm.platform.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.plm.platform.module.system.controller.admin.user.vo.user.*;
import com.plm.platform.module.system.dal.dataobject.dept.DeptDO;
import com.plm.platform.module.system.dal.dataobject.dept.PostDO;
import com.plm.platform.module.system.dal.dataobject.dept.UserPostDO;
...
import com.plm.platform.module.system.dal.mysql.dept.UserPostMapper;
import com.plm.platform.module.system.dal.mysql.user.AdminUserMapper;
import com.plm.platform.module.system.enums.common.SexEnum;
...
import com.plm.platform.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("platformyuanma");
        ...
        assertEquals("platformyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("platformyuanma"))).thenReturn("java");

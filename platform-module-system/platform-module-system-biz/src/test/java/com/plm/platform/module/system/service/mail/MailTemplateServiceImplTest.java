package com.plm.platform.module.system.service.mail;
...
import com.plm.platform.module.system.controller.admin.mail.vo.template.MailTemplateCreateReqVO;
import com.plm.platform.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.plm.platform.module.system.controller.admin.mail.vo.template.MailTemplateUpdateReqVO;
import com.plm.platform.module.system.dal.dataobject.mail.MailTemplateDO;
import com.plm.platform.module.system.dal.mysql.mail.MailTemplateMapper;
import com.plm.platform.module.system.mq.producer.mail.MailProducer;
...
import static com.plm.platform.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
       ...
       // 测试 name 不匹配
       mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("PDM")));
       // 测试 code 不匹配

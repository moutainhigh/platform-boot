package com.plm.platform.module.system.service.tenant;

import com.plm.platform.framework.common.enums.CommonStatusEnum;
import com.plm.platform.framework.common.pojo.PageResult;
import com.plm.platform.framework.tenant.config.TenantProperties;
import com.plm.platform.framework.tenant.core.context.TenantContextHolder;
import com.plm.platform.framework.test.core.ut.BaseDbUnitTest;
import com.plm.platform.module.system.controller.admin.tenant.vo.tenant.TenantCreateReqVO;
import com.plm.platform.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import com.plm.platform.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.plm.platform.module.system.controller.admin.tenant.vo.tenant.TenantUpdateReqVO;
import com.plm.platform.module.system.dal.dataobject.permission.MenuDO;
import com.plm.platform.module.system.dal.dataobject.permission.RoleDO;
...
import com.plm.platform.module.system.dal.mysql.tenant.TenantMapper;
import com.plm.platform.module.system.enums.permission.RoleCodeEnum;
import com.plm.platform.module.system.enums.permission.RoleTypeEnum;
import com.plm.platform.module.system.service.permission.MenuService;
...
import com.plm.platform.module.system.service.tenant.handler.TenantInfoHandler;
import com.plm.platform.module.system.service.tenant.handler.TenantMenuHandler;
import com.plm.platform.module.system.service.user.AdminUserService;
...
import static com.plm.platform.framework.common.util.collection.SetUtils.asSet;
import static com.plm.platform.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.plm.platform.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.plm.platform.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.plm.platform.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.plm.platform.framework.test.core.util.AssertUtils.assertServiceException;
import static com.plm.platform.framework.test.core.util.RandomUtils.*;
import static com.plm.platform.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static com.plm.platform.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("PDM", user.getNickname());
        ...
        TenantCreateReqVO reqVO = randomPojo(TenantCreateReqVO.class, o -> {
            o.setContactName("PDM");
            o.setContactMobile("15601691300");
            o.setPackageId(100L);
            o.setStatus(randomCommonStatus());
            o.setDomain("https://www.example.com");
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("PDM"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("PDM");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }

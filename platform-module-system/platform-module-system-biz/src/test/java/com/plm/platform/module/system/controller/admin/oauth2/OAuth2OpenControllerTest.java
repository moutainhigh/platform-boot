package com.plm.platform.module.system.controller.admin.oauth2;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.plm.platform.framework.common.core.KeyValue;
import com.plm.platform.framework.common.enums.UserTypeEnum;
import com.plm.platform.framework.common.exception.ErrorCode;
import com.plm.platform.framework.common.pojo.CommonResult;
import com.plm.platform.framework.common.util.collection.SetUtils;
import com.plm.platform.framework.common.util.object.ObjectUtils;
import com.plm.platform.framework.test.core.ut.BaseMockitoUnitTest;
import com.plm.platform.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.plm.platform.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.plm.platform.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.plm.platform.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.plm.platform.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.plm.platform.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.plm.platform.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.plm.platform.module.system.service.oauth2.OAuth2ApproveService;
import com.plm.platform.module.system.service.oauth2.OAuth2ClientService;
import com.plm.platform.module.system.service.oauth2.OAuth2GrantService;
import com.plm.platform.module.system.service.oauth2.OAuth2TokenService;
...
import static com.plm.platform.framework.test.core.util.RandomUtils.randomPojo;
import static com.plm.platform.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.example.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read", result.getData());
    }

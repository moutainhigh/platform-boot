...
import com.plm.platform.framework.sms.config.PlatformSmsAutoConfiguration;
import com.plm.platform.module.system.test.BaseDbAndRedisIntegrationTest;
import com.plm.platform.module.system.mq.consumer.sms.SmsSendConsumer;
...
// TODO @测试：需要迁移
@Import({PlatformSmsAutoConfiguration.class,

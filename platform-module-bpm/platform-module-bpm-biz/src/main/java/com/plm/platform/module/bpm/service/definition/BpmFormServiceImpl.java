...
import com.plm.platform.module.bpm.convert.definition.BpmFormConvert;
...
import com.plm.platform.module.bpm.enums.ErrorCodeConstants;
...
public class BpmFormServiceImpl implements BpmFormService {
    ...
    private void checkFields(List<String> fields) {
        if (true) { // TODO 测试：兼容 Vue3 工作流：因为采用了新的表单设计器，所以暂时不校验
            return;
        }

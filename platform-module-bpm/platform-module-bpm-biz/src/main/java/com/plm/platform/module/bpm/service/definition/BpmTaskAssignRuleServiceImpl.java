package com.plm.platform.module.bpm.service.definition;
...
import com.plm.platform.framework.datapermission.core.annotation.DataPermission;
import com.plm.platform.framework.flowable.core.util.FlowableUtils;
import com.plm.platform.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleCreateReqVO;
import com.plm.platform.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleRespVO;
import com.plm.platform.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleUpdateReqVO;
import com.plm.platform.module.bpm.convert.definition.BpmTaskAssignRuleConvert;
import com.plm.platform.module.bpm.dal.dataobject.definition.BpmTaskAssignRuleDO;
import com.plm.platform.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import com.plm.platform.module.bpm.dal.mysql.definition.BpmTaskAssignRuleMapper;
import com.plm.platform.module.bpm.enums.definition.BpmTaskAssignRuleTypeEnum;
import com.plm.platform.module.bpm.enums.DictTypeConstants;
import com.plm.platform.module.bpm.framework.flowable.core.behavior.script.BpmTaskAssignScript;
import com.plm.platform.module.system.api.dept.DeptApi;
import com.plm.platform.module.system.api.dept.PostApi;
...
import com.plm.platform.module.system.api.permission.RoleApi;
import com.plm.platform.module.system.api.user.AdminUserApi;
import com.plm.platform.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.plm.platform.framework.common.util.collection.CollectionUtils.convertMap;
import static com.plm.platform.framework.common.util.collection.CollectionUtils.convertSet;
import static com.plm.platform.framework.common.util.json.JsonUtils.toJsonString;
import static com.plm.platform.module.bpm.enums.ErrorCodeConstants.*;

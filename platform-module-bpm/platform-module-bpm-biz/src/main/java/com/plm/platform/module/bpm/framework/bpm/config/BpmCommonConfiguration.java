package com.plm.platform.module.bpm.framework.bpm.config;

import com.plm.platform.module.bpm.framework.bpm.core.event.BpmProcessInstanceResultEventPublisher;

package com.plm.platform.module.bpm.controller.admin.task.vo.task;
...
public class BpmTaskTodoPageItemRespVO {
    ...
    @Schema(description = "任务名字", required = true, example = "PDM")
    private String name;
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", required = true, example = "PDM")
        private String name;

        @Schema(description = "发起人的用户编号", required = true, example = "1024")
        private Long startUserId;

        @Schema(description = "发起人的用户昵称", required = true, example = "测试")

...
import com.plm.platform.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
...
import com.plm.platform.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.plm.platform.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("PDM")));
       // 测试 status 不匹配
